...
#SBATCH --nodelist=laniakea                  # <--- 指定节点 (或者 voyager/galaxy)
...
# --- 脚本路径 ---
# 你的计算脚本路径
SCRIPT_PATH="/home/dongbos/Combine_optim_Borzoi_SNP/src/interpretability/fig3_table_tissuespecific_multimodal/cal_fig3_datamatrix.py"
