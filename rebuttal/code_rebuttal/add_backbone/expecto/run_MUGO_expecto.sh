...
# ================= ⚙️ 配置区域 =================
# Python 脚本绝对路径
PYTHON_SCRIPT="/home/dongbos/Combine_optim_Borzoi_SNP/rebuttal/code_rebuttal/add_backbone/expecto/expecto_CAGE_MUGO.py"

# CSV 名单所在的根目录
CSV_DIR="/home/dongbos/Combine_optim_Borzoi_SNP/src/interpretability/newversion_table2/top100_highexp_gene"

# 日志目录
LOG_DIR="/home/dongbos/Combine_optim_Borzoi_SNP/rebuttal/results_rebuttal/add_backbone_model/expecto/logs"
mkdir -p "$LOG_DIR"
...
echo "========================================================"
echo "🚀 Submitting ExPecto MUGO (Top $TOP_N Genes per Tissue)"
echo "========================================================"
...
echo "Starting ExPecto MUGO for $TISSUE on node \${SLURMD_NODENAME}"
