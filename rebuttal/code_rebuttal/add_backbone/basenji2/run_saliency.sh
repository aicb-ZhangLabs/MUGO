...
# ================= ⚙️ 配置区域 =================
PYTHON_SCRIPT="/home/dongbos/Combine_optim_Borzoi_SNP/rebuttal/code_rebuttal/add_backbone/basenji2/basenji2_saliency_CAGE.py"

CSV_DIR="/home/dongbos/Combine_optim_Borzoi_SNP/src/interpretability/newversion_table2/top100_highexp_gene"

LOG_DIR="/home/dongbos/Combine_optim_Borzoi_SNP/rebuttal/results_rebuttal/add_backbone_model/basenji2/basenji2_saliency_slurm_logs"
mkdir -p "$LOG_DIR"
...
echo "========================================================"
echo "🚀 Submitting Basenji2 Saliency (Top $TOP_N Genes)"
echo "========================================================"
...
echo "Starting Basenji2 Saliency for $TISSUE on node \${SLURMD_NODENAME}"
