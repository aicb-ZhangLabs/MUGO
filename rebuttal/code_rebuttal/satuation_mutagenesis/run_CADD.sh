...
# ================= ⚙️ 配置区域 =================
PYTHON_SCRIPT="/home/dongbos/Combine_optim_Borzoi_SNP/rebuttal/code_rebuttal/satuation_mutagenesis/CADD_borzoi_RNA_satuation_mutagenesis.py"
...
echo "========================================================"
echo "🚀 Submitting CADD Saturation Mutagenesis (Top $TOP_N Genes)"
echo "========================================================"
...
echo "Starting CADD Saturation Mutagenesis for $TISSUE"
...
for GENE in "\${GENES[@]}"; do
    ...
    for N_VAL in ${N_WINDOWS[@]}; do
        echo "   👉 Querying CADD for N=\$N_VAL..."
