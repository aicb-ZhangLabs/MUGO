#!/bin/bash
#SBATCH --job-name=MVP_A6000_Seq             # <--- 改个名，一眼看出是串行
#SBATCH --array=1181-2359%6                        # <--- 你的 array 设定
...
#SBATCH --mem=48G                            # <--- 给足内存，防止 System RAM 不够
#SBATCH --nodes=1
...
# --- 运行代码 ---
SCRIPT_PATH="/home/dongbos/Combine_optim_Borzoi_SNP/src/train_model/MVP_multi_head_borzoi_CAGE.py"
